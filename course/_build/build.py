...
LESSONS: list[Lesson] = [
    Lesson(
        ...
        description="The difference between Copilot CLI and other Copilots, and why it earns a slot in your daily workflow as a Microsoft partner.",
    ),
    Lesson(
    ...
    Lesson(
        ...
        eyebrow="Foundations",
        time="20 min",
        outcome="Analyze RFPs, customer decks, transcripts, and proposal docs.",
    ...
    Lesson(
        ...
        title="MCP power-ups: GitHub, M365, and more",
        eyebrow="Plug into your work",
        time="20 min",
        outcome="Connect Copilot to your inbox, calendar, and repos.",
        description="Wire up the MCP servers that let Copilot read your real work, in natural language.",
    ),
]
