...
Useful for customer asset libraries, repo dumps, document archives.
...
| A talk track for a meeting | "Give me a 3-minute talking script with 3 questions to ask the customer" |
...
⚠️ The CLI is great at extracting and structuring. It is mediocre at:

- **Math.** It will quote numbers from the doc. Don't trust it to add things up. Verify.
- **Specifics it can't see.** It won't know "what did this customer do last quarter" unless that info is in the doc you gave it.
- **Knowing when it is wrong.** It will sound confident even when it is hallucinating. Spot-check.
